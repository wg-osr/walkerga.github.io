...
<ins>Catastrophe</ins> : Terrible consequences for misusing magic. Happens when a spell creates a paradox, or when more Dice are cast than allowed.
...
- <ins>sigil</ins> is permanent, but is capped by the number of Magic User templates.
