...
// http://en.wikipedia.org/wiki/JSON
  ...
  gen_data['main'] = [
    'This {2d6hexes}-hex cold region is known for its {adjective} {feature}. Beware, for there are {obstacle} that {hazard} in the area. It is the land of the {monster}, and also the {monster}. <br><br>'
  ];
  gen_data['2d6hexes'] = {
    '01-03': 'two',
    '04-08': 'three',
  ...
  gen_data['monster'] = [
    ...
    'Cycops, who {cyclopsculture} {cyclopsproblem}',
    'Cycopskin, who {cyclopskinculture} {cyclopskinproblem}',
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  <body>
    <p><textarea id="output" cols="90" rows="3" readonly></textarea></p>
